...
public abstract class FetchWeatherForecastTask extends AsyncTask<String, Void, String[]> {

    private static final String TAG = FetchWeatherForecastTask.class.getSimpleName();

    public static final String PATH_FORECAST = "//api.openweathermap.org/data/2.5/forecast/daily";

    public static final String API_TOKEN = "f6bbdb63892a25018fa8725805fc1693";

    public static final String PARAM_QUERY = "q";
    public static final String PARAM_MODE = "mode";
    public static final String PARAM_UNITS = "units";
    public static final String PARAM_DAYS = "cnt";
    public static final String PARAM_TOKEN = "appid";

    /**
     * @param params first param is postcode to query
    ...
    @Override protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            return getWeatherDataFromJson(buffer.toString(), daysNum);
        } catch (IOException e) {
            Log.e(TAG, "Error ", e);
    ...
    @Override protected abstract void onPostExecute(String[] result);
